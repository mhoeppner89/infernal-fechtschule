import type { LessonId } from './types.js';
 ...
 */
export const LESSON_OFFERS: readonly (readonly LessonId[])[] = Object.freeze([
  Object.freeze<LessonId[]>(['ls-crossing', 'ds-backhand']),
  Object.freeze<LessonId[]>(['ls-threefold', 'ds-wheel']),
  Object.freeze<LessonId[]>(['switch-flourish', 'ls-provoker']),
  Object.freeze<LessonId[]>(['ls-crossing', 'ds-backhand']),
  Object.freeze<LessonId[]>(['ls-threefold', 'ds-wheel']),
  Object.freeze<LessonId[]>(['switch-flourish', 'ls-provoker'])
]);
