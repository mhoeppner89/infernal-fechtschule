import { ENEMY_TEMPO, attackDuration, getAttack, isHitZoneExposed, isAttackActive, isImprovisedWeapon, resolveCrouchAttack, resolveDodgeAttack, resolvePlayerAttack, resolveSwitchAttack, throwAttackFor } from './attacks.js';
...
export class GameWorld {
    ...
    updatePlayer(actor, input, dt) {
        ...
        if (actor.state === 'dodge') {
            ...
            if (input.lightPressed && actor.stateElapsed > 0.045 && actor.stateElapsed < 0.22) {
                ...
                if (actor.weapon === 'dussack' && this.lessons.has('ds-wheel'))
    ...
    updatePlayerAttack(actor, input, dt) {
        ...
        const linkOpen = !definition.heavy
            ...
            && runtime.elapsed >= definition.startup + definition.active;
        if (runtime.elapsed < attackDuration(definition) && !(linkOpen && runtime.queuedAction !== null))
            return;
